...
> 🇺🇸 **English speakers:** For English installation instructions and **Open-Source Self-Hosted Supabase** (`https://supabase.com/open-source`) support, see [README.en.md](README.en.md) and run `bash hostgator-setup-kit/install.sh`.
